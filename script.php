...
function validCard($num){
  ...
  $sum = array_sum($output_array);
    if($sum % 10 === 0){
      echo "<h1 style='color:#8C837B; text-align:center; padding: 200px;'>" . 'TRUE: This IS a valid card number.' . "</h1>";
    } else {
      echo "<h1 style='color:#8C837B; text-align:center; padding: 200px;'>" . 'FALSE: This is NOT a valid card number.' . "</h1>";
  }
};
